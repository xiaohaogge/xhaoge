...
def getcurrencyrate(fromC="USD",toC="USD"):
	url = "http://test-restful-api.gloryholiday.com/nightking/exchangeRate?providerName=%22%22&cid=iwoflyCOM&originalCode={}&targetCode={}".format(fromC,toC)
...
def countCurrencyPolicy():
	...
	print("服务费用为：",round(Yserver,2),payC,"\n")
	print("-------------------------------------")
