...
class Case_Others_Platform_Update(CaseBase):
    ...
    def TestProcess(self):
        ...
        data0 = '''
                ...
                "baseInfo":{"id":"5d3fee6db8d7ea000165e374","revision":27,"displayNumber":"PFC1907306359","archived":false,"enabled":true,"creator":"jingyun.chen","createdAt":"2019-09-22 17:17","traceId":"","policyNumber":""},"platformInfo":{"name":"去哪人商旅ha","subsite":"qunarytb","cid":"qunarytb"},
                ...
                "displayNumber":"PFC1907306359","archived":false,"enabled":true,"creator":"jingyun.chen","createdAt":"2019-09-22 17:17","traceId":"","policyNumber":""}
                '''
    ...
    def TestResult(self):
        ...
        if self.flag:
            ...
            self.log.info('=========Case_Others_Platform_Update,测试失败')
